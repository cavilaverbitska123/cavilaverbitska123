...
describe = {'Сумма уникальных чисел':
                sum_of_numbers,
            "Количество уникальных чисел": avarage_of_numbers,}
print(describe)

#Задача 1: первый и последний лыжник
list_participants = ["Орлов", "Петров", "Иванов", "Васильев","Черепахов"]
last_participants[-1]
...
sps_books = ["Дубровский","Горе от ума", "Кавказский пленник", "Хамелеон"]
lasy_book = sps_books[-1]
catalog = {'пушкин': sps_books[0]}
print(f"Последняя книга: {last_book}")
print(f"Первая книга Пушкина: {catalog['Пушкин']}")

#Задача 3: покупки винтернет магазине
shopping_list =['Палатка',"Cпальник", "котелок "]
